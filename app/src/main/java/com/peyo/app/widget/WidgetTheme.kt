...
import com.peyo.app.MainActivity
import com.peyo.app.ui.theme.PeyoDarkColors
import com.peyo.app.ui.theme.PeyoLightColors
...
enum class WidgetAction(val intentAction: String?) {
    OPEN(null),
    ADD("com.peyo.app.ADD_EXPENSE"),
    SPLIT("com.peyo.app.SPLIT_EXPENSE"),
    IMPORT("com.peyo.app.IMPORT_PDF"),
    BALANCES("com.peyo.app.OPEN_BALANCES");
